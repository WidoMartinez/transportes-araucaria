...
const PromocionBanner = sequelize.define(
  "PromocionBanner",
  {
    ...
    // Configuración Avanzada: Sillas y Anticipación
    permite_sillas: {
      type: DataTypes.BOOLEAN,
      defaultValue: false,
      comment: "Si la promoción permite agregar sillas infantiles",
    },
    max_sillas: {
      type: DataTypes.INTEGER,
      defaultValue: 0,
      comment: "Número máximo de sillas permitidas",
    },
    valor_silla: {
      type: DataTypes.INTEGER,
      defaultValue: 0,
      comment: "Valor extra por cada silla infantil",
    },
    anticipacion_minima: {
      type: DataTypes.INTEGER,
      defaultValue: 3,
      comment: "Horas mínimas de anticipación requeridas para reservar",
    },
  },
  {

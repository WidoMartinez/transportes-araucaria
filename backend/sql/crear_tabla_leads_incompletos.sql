-- Script SQL para crear tabla de leads incompletos
-- Propósito: Capturar información de usuarios que inician una reserva pero no completan el pago
-- Este script es de referencia; la tabla se crea automáticamente mediante la migración
-- backend/migrations/add-leads-incompletos-table.js

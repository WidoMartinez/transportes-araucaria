...
import transferService from './assets/transfer-service.jpg'
...
function App() {
  ...
  const testimonios = [
    {
      ...
      comentario: 'Excelente servicio, muy puntual y cómodo. El conductor fue muy amable.',
      calificacion: 5
    },
    {
      nombre: 'Carlos Rodríguez',
      comentario: 'Perfecto para llegar a Pucón desde el aeropuerto. Lo recomiendo 100%.',
      calificacion: 5
    },
    {
      nombre: 'Ana Martínez',
      comentario: 'Muy profesional, vehículo limpio y precio justo. Volveré a usar el servicio.',
      calificacion: 5
    }
  ]
  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-2">
              ...
              <h1 className="text-2xl font-bold text-primary">Transportes Araucaria</h1>
            </div>
            <nav className="hidden md:flex space-x-6">
              ...
              <a href="#destinos" className="text-foreground hover:text-primary transition-colors">Destinos</a>
              <a href="#tarifas" className="text-foreground hover:text-primary transition-colors">Tarifas</a>
      ...
      {/* Hero Section */}
      <section id="inicio" className="relative bg-gradient-to-r from-primary to-secondary text-white py-20">
        ...
        <div className="relative container mx-auto px-4 text-center">
          ...
          <Card className="max-w-4xl mx-auto bg-white/95 backdrop-blur-sm">
            <CardHeader>
              <CardTitle className="text-foreground text-center">Reserva tu Transfer</CardTitle>
            </CardHeader>
            <CardContent>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Ofrecemos diferentes opciones de transporte para satisfacer tus necesidades
            </p>
          </div>
      ...
      <section id="destinos" className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Conectamos el aeropuerto con los destinos más populares de La Araucanía
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {destinos.map((destino, index) => (
              <Card key={index} className="overflow-hidden hover:shadow-lg transition-shadow">
                <div className="h-48 bg-cover bg-center" style={{ backgroundImage: `url(${destino.imagen})` }}></div>
                <CardHeader>
      ...
      <section className="py-20 bg-primary text-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold mb-4">¿Por qué elegir Transportes Araucaria?</h2>
            <p className="text-xl opacity-90 max-w-2xl mx-auto">
              Más de 10 años de experiencia brindando el mejor servicio de transfer en La Araucanía
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="opacity-90">Llegamos siempre a tiempo para que no pierdas tu vuelo o conexión.</p>
              </div>
            </div>
            <div className="flex items-start space-x-4">
              <CheckCircle className="h-8 w-8 text-accent flex-shrink-0 mt-1" />
              <div>
                ...
                <p className="opacity-90">Flota renovada con aire acondicionado, WiFi y máxima comodidad.</p>
              </div>
            </div>
            <div className="flex items-start space-x-4">
              <CheckCircle className="h-8 w-8 text-accent flex-shrink-0 mt-1" />
              <div>
                <h3 className="text-xl font-semibold mb-2">Conductores Profesionales</h3>
                <p className="opacity-90">Personal capacitado, con licencia profesional y conocimiento local.</p>
              </div>
            </div>
            <div className="flex items-start space-x-4">
              <CheckCircle className="h-8 w-8 text-accent flex-shrink-0 mt-1" />
              <div>
                ...
                <p className="opacity-90">Precios justos sin sorpresas, con descuentos para grupos.</p>
              </div>
            </div>
            <div className="flex items-start space-x-4">
              <CheckCircle className="h-8 w-8 text-accent flex-shrink-0 mt-1" />
              <div>
                ...
                <p className="opacity-90">Servicio disponible todos los días, adaptándonos a tu horario.</p>
              </div>
            </div>
            <div className="flex items-start space-x-4">
              <CheckCircle className="h-8 w-8 text-accent flex-shrink-0 mt-1" />
              <div>
                ...
                <p className="opacity-90">Monitoreo del vuelo y comunicación constante vía WhatsApp.</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonios.map((testimonio, index) => (
              <Card key={index}>
                ...
                <CardContent>
                  <p className="text-muted-foreground italic">"{testimonio.comentario}"</p>
                </CardContent>
              </Card>
            ))}
          </div>
              ...
              <CardContent className="space-y-6">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">+56 9 8765 4321</p>
                  </div>
                </div>
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">contacto@transportesaraucaria.cl</p>
                  </div>
                </div>
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">Temuco, Región de La Araucanía</p>
                  </div>
                </div>
                <div className="flex items-center space-x-3">
      ...
      <footer className="bg-primary text-white py-12">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="opacity-90 mb-4">
                Tu mejor opción para traslados desde el Aeropuerto La Araucanía hacia toda la región.
              </p>
          ...
          <div className="border-t border-white/20 mt-8 pt-8 text-center opacity-90">
            <p>&copy; 2024 Transportes Araucaria. Todos los derechos reservados.</p>
          </div>
        </div>
      </footer>
    </div>

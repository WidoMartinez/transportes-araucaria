...
function Hero({
        ...
        }, [showSummary, formData.destino, formData.fecha, formData.nombre, formData.telefono]);
        ...
        const handleStepOneNext = () => {
                ...
                if (formData.destino === "Otro" && !formData.otroDestino.trim()) {
                        setStepError("Cuéntanos cuál es tu destino.");
                        return;
                }
        ...
        const handleStepTwoNext = async () => {
                ...
                if (!formData.email.trim()) {
                        setStepError("Necesitamos un correo electrónico para enviar la confirmación.");
                        return;
                }
                ...
                >
                        ...
                        <div className="relative container mx-auto px-4 text-center">
                                ...
                                <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto">
                                        Diseñamos una reserva guiada paso a paso para que confirmes y pagues tu viaje de forma
                                        autónoma, asegurando el {discountPercentage}% de descuento online.
                                </p>
                                        ...
                                        <CardContent className="space-y-8">
                                                {currentStep === 0 && (
                                                        <div className="space-y-6">
                                                                ...
                                                                {formData.destino === "Otro" && (
                                                                        <div className="space-y-2">
                                                                                <Label htmlFor="otroDestino-hero">Especificar otro destino</Label>
                                                                                <Input
                                                                                        id="otroDestino-hero"
                                                                                        name="otroDestino"
                                                                ...
                                                                {mostrarPrecio ? (
                                                                        ...
                                                                        <div className="rounded-xl border border-dashed border-primary/40 bg-white/40 p-6 text-primary">
                                                                                <p className="font-semibold">
                                                                                        Calcularemos el valor exacto y te lo enviaremos junto con la confirmación.
                                                                                </p>
                                                                                <p className="text-sm text-primary/80">
                                                                                        Indícanos tu destino para sugerirte el vehículo más conveniente.
                                                                                </p>
                                                                        </div>
                                                                )}
                                                                ...
                                                                <div className="flex flex-col gap-3 sm:flex-row sm:justify-between sm:items-center">
                                                                        <p className="text-sm text-muted-foreground">
                                                                                Revisaremos disponibilidad en tiempo real antes de pasar al pago.
                                                                        </p>
                                                                        <Button
                                                                                type="button"
                                                ...
                                                {currentStep === 1 && (
                                                        <div className="space-y-6">
                                                                ...
                                                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                                                        ...
                                                                        <div className="space-y-2">
                                                                                <Label htmlFor="numeroVuelo-hero">Número de vuelo (si aplica)</Label>
                                                                                <Input
                                                                                        id="numeroVuelo-hero"
                                                                                        name="numeroVuelo"
                                                                ...
                                                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                                                        ...
                                                                        <div className="space-y-2">
                                                                                <Label htmlFor="sillaInfantil-hero">¿Necesitas silla infantil?</Label>
                                                                                <select
                                                                ...
                                                                {mostrarPrecio && (
                                                                        <div className="rounded-xl border border-secondary/30 bg-secondary/10 p-6 text-foreground">
                                                                                ...
                                                                                <p className="mt-3 text-xs text-muted-foreground">
                                                                                        Podrás elegir entre abonar el 40% o pagar el total con descuento en el siguiente paso.
                                                                                </p>
                                                                        </div>
                                                                )}

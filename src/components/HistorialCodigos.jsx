...
export default function HistorialCodigos() {
  ...
  const cargarHistorial = async () => {
    try {
      ...
      const response = await fetch(`${API_BASE_URL}/api/codigos/historial?${params}`);
  ...
  const exportarCSV = () => {
    ...
    link.setAttribute('download', `historial_codigos_${new Date().toISOString().split('T')[0]}.csv`);
            ...
            <CardContent className="p-4">
              <div className="flex items-center space-x-2">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold">{estadisticas.usuariosUnicos}</p>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-4">
              <div className="flex items-center space-x-2">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold">{formatearMonto(estadisticas.totalDescuentos)}</p>
                </div>
              </div>
            </CardContent>
          </Card>
              ...
              <TableBody>
                {historial.map((item, index) => (
                  <TableRow key={index}>
                    ...
                    <TableCell>
                      <Badge variant={
                        item.estadoPago === 'pagado' ? 'default' : 
                        item.estadoPago === 'pendiente' ? 'secondary' : 
                        'destructive'
                      }>
                        {item.estadoPago}
                      </Badge>
